...
// For example,  and . For elements , Bob is awarded a point because . For the equal elements  and , no points are 
//earned. Finally, for elements ,  so Alice receives a point. Your return array would be  with Alice's score first 
//and Bob's second.
...
function compareTriplets(alice, bob) {
    ...
    bothScores.push(alicesScore, bobsScore)
